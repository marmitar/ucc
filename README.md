...
[link](https://github.com/mc921-1s21/notebooks-1S21/blob/master/P2-Parser.ipynb).
...
You can run `uc_parser_clean.py` directly with python. For more information, run:
```sh
    python3 uc/uc_parser_clean.py -h
```
